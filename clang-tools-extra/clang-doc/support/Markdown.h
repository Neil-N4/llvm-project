...
//===----------------------------------------------------------------------===//
// ASTContext -- owns the arena and all allocated nodes
//===----------------------------------------------------------------------===//
...
/// Owns the bump pointer arena for all Markdown AST nodes. Nodes allocated
/// via allocate() have their lifetime tied to the ASTContext.
class ASTContext {
...
public:
  ...
  /// Copy a string into the arena so its lifetime matches the ASTContext.
